		      ...
		      <div class="col-md-8 col-lg-6 col-xl-4">
		        ...
		        <div class="card" style="border-radius: 15px;">
		          ...
		          <div class="card-body pb-0">
		            ...
		            <p class="small text-muted">No Of Seats : <%=flight.getNumberOfSeats() %></p>
		          ...
		          <div class="card-body pb-0">
		            <div class="d-flex justify-content-between">
		              <p>Ticket Id</a></p>
		              <p class="text-dark"><%=tickets.get(i).getId() %></p>
		            </div>
		            <div class="d-flex justify-content-between">
		              <p>Booked Seat Count : </a></p>
		              <p class="text-dark"><%=tickets.get(i).getNumberOfSeats() %></p>
		            </div>
		            <p class="small text-muted">Payment Status : <%=tickets.get(i).getPaymentStatus() %></p>
		          </div>
